...
/* ========================================================================================== */
  ...
  $("#bTable").click(function() {
    ...
    location.href=base_url+"page/pbbnondpData";      
  });
  ...
  $("#bViewJurnal").click(function() {
      ...
      $.ajax({ 
        ...
        "beforeSend": function(){
          ...
          parent.window.$("#modaltrigger").val("iframe-page-pbbnondp");
  ...
  $("#bprint").click(() => {
      if($('#id').val()=='') return;    
      window.open(`${base_url}Laporan/preview/page-pbbnondp/${$("#id").val()}`)    
  });
...
var _addRow = () => {
  let newrow = " <tr>";
      ...
      newrow += "<td><textarea name=\"catatan[]\" class=\"form-control form-control-sm\" rows=\"1\" autocomplete=\"off\" style=\"resize:none\"></textarea></td>";
      ...
      if(result.pesan=='sukses'){
          parent.window.Swal.fire({
              ...
              if (printing.isConfirmed) {
                window.open(`${base_url}Laporan/preview/page-pbbnondp/${result.nomor}`)
              }
