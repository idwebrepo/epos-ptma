/* ========================================================================================== */
/* File Name : table-keluar-barang.js
/* Info Lain : 
/* ========================================================================================== */
...
$(function() {
	...
	"dom": '<"top"pi>tr<"clear">',
	"ajax": {
	    "url":base_url+"Datatable_Transaksi_Full/view_keluar_barang_pembelian",
	    "type":"post",
        "data": function(data){
	...
	$("#badd").click(function() {
		...
		location.href=base_url+"page/bkr";      
	});
	...
	$("#bedit").click(function() {
		...
		parent.window.$('.loader-wrap').removeClass('d-none');
		location.href=base_url+"page/bkr/?id="+id;      
	});
	...
	$("#bprint").click(() => {
		...
		window.open(`${base_url}Laporan/preview/page-bkr/${id}`)
	});	
