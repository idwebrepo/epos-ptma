/* ========================================================================================== */
/* File Name : table-terima-barang.js
/* Info Lain : 
/* ========================================================================================== */
...
$(function() {
	...
	"dom": '<"top"pi>tr<"clear">',
	"ajax": {
	    "url":base_url+"Datatable_Transaksi_Full/view_penerimaan_barang",
	    "type":"post",
        "data": function(data){
	...
	$("#badd").click(function() {
		...
		location.href=base_url+"page/pbbnondp";      
	});
	...
	$("#bedit").click(function() {
		...
		parent.window.$('.loader-wrap').removeClass('d-none');
		location.href=base_url+"page/pbbnondp/?id="+id;      
	});
	...
	$("#bprint").click(() => {
		...
		window.open(`${base_url}Laporan/preview/page-pbbnondp/${id}`)
	});
