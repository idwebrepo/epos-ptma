...
/* ========================================================================================== */
  ...
  $("#bprint").click(() => {
      ...
      window.open(`${base_url}Laporan/preview/page-fpjn/${$("#id").val()}`)    
  });
...
var _IsValid = () => {
    ...
    if ($('#idkaryawan').val()==''){
      $('#karyawan').attr('data-title','Salesman harus diisi !');      
      ...
      if(result.pesan=='sukses'){
          parent.window.Swal.fire({
              ...
              if (printing.isConfirmed) {
                ...
                window.open(`${base_url}Laporan/preview/page-fpjn/${result.nomor}`)
              }
    ...
    "success" : async function(result){
      if (typeof result.pesan !== 'undefined') { 
        ...
        $.each(result.data, function() {
          ...
          $("input[name^='defharga']").eq(rows).val(result.data[datarows]['hargajual']);          
          ...
          $("input[name^='jharga1sat1']").eq(rows).val(result.data[datarows]['hargajual']);                            
          $("input[name^='jharga2sat1']").eq(rows).val(result.data[datarows]['hargajual2']);                            
          $("input[name^='jharga3sat1']").eq(rows).val(result.data[datarows]['hargajual3']);                            
          $("input[name^='jharga4sat1']").eq(rows).val(result.data[datarows]['hargajual4']);
          $("input[name^='jharga1sat2']").eq(rows).val(result.data[datarows]['sat2hargajual1']);                            
          $("input[name^='jharga2sat2']").eq(rows).val(result.data[datarows]['sat2hargajual2']);                            
          $("input[name^='jharga3sat2']").eq(rows).val(result.data[datarows]['sat2hargajual3']);                            
          $("input[name^='jharga4sat2']").eq(rows).val(result.data[datarows]['sat2hargajual4']);
          $("input[name^='jharga1sat3']").eq(rows).val(result.data[datarows]['sat3hargajual1']);                            
          $("input[name^='jharga2sat3']").eq(rows).val(result.data[datarows]['sat3hargajual2']);                            
          $("input[name^='jharga3sat3']").eq(rows).val(result.data[datarows]['sat3hargajual3']);                            
          $("input[name^='jharga4sat3']").eq(rows).val(result.data[datarows]['sat3hargajual4']);                                                                                
          $("input[name^='jharga1sat4']").eq(rows).val(result.data[datarows]['sat4hargajual1']);                            
          $("input[name^='jharga2sat4']").eq(rows).val(result.data[datarows]['sat4hargajual2']);                            
          $("input[name^='jharga3sat4']").eq(rows).val(result.data[datarows]['sat4hargajual3']);                            
          $("input[name^='jharga4sat4']").eq(rows).val(result.data[datarows]['sat4hargajual4']);
          $("input[name^='jharga1sat5']").eq(rows).val(result.data[datarows]['sat5hargajual1']);                            
          $("input[name^='jharga2sat5']").eq(rows).val(result.data[datarows]['sat5hargajual2']);                            
          $("input[name^='jharga3sat5']").eq(rows).val(result.data[datarows]['sat5hargajual3']);                            
          $("input[name^='jharga4sat5']").eq(rows).val(result.data[datarows]['sat5hargajual4']);
          $("input[name^='jharga1sat6']").eq(rows).val(result.data[datarows]['sat6hargajual1']);                            
          $("input[name^='jharga2sat6']").eq(rows).val(result.data[datarows]['sat6hargajual2']);                            
          $("input[name^='jharga3sat6']").eq(rows).val(result.data[datarows]['sat6hargajual3']);                            
          $("input[name^='jharga4sat6']").eq(rows).val(result.data[datarows]['sat6hargajual4']);
          ...
          if(result.data[datarows]['gudang'] != null) $("select[name^='gudangdetil']").eq(rows).append(_gudang).trigger('change');
