...
$(function() {
	...
	$("#badd").click(function() {
        ...
        parent.window.$('.content-wrapper').IFrame('createTab', 'Penjualan Tunai', 'page/pos', 'page-pos', true, 'Penjualan Tunai');		
	});
	...
	$("#bedit").click(function() {
		...
		parent.window.$('.loader-wrap').removeClass('d-none');
        parent.window.$('.content-wrapper').IFrame('createTab', 'Transaksi POS', 'page/pos/?id='+id, 'page-pos', true, 'Transaksi POS');				
	});
