/* ========================================================================================== */
/* File Name : table-penyesuaian-barang.js
/* Info Lain : 
/* ========================================================================================== */
...
$(function() {
	...
	"dom": '<"top"pi>tr<"clear">',
	"ajax": {
	    "url":base_url+"Datatable_Transaksi_Full/view_penyesuaian_barang",
	    "type":"post",
        "data": function(data){
	...
	$("#badd").click(function() {
		...
		location.href=base_url+"page/stokadj";      
	});
	...
	$("#bedit").click(function() {
		...
		parent.window.$('.loader-wrap').removeClass('d-none');
		location.href=base_url+"page/stokadj/?id="+id;      
	});
	...
	$("#bprint").click(() => {
		...
		window.open(`${base_url}Laporan/preview/page-stokadj/${id}`)
	});			
