/* ========================================================================================== */
/* File Name : table-stok-opname.js
/* Info Lain : 
/* ========================================================================================== */
...
$(function() {
	...
	"dom": '<"top"pi>tr<"clear">',
	"ajax": {
	    "url":base_url+"Datatable_Transaksi_Full/view_stok_opname",
	    "type":"post",
        "data": function(data){
	...
	$("#badd").click(function() {
		...
		location.href=base_url+"page/opname";      
	});
	...
	$("#bedit").click(function() {
		...
		parent.window.$('.loader-wrap').removeClass('d-none');
		location.href=base_url+"page/opname/?id="+id;      
	});
	...
	$("#bprint").click(() => {
		...
		window.open(`${base_url}Laporan/preview/page-opname/${id}`)
	});			
