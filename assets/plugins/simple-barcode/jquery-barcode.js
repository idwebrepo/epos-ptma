...
(function ($) {
  ...
  function digitToCssRenderer($container, settings, digit, hri, mw, mh) {
    ...
    if (settings.showHRI) {
      content += "<div id=\"digitBar\" style=\"clear:both; width: 100%; background-color: " + settings.bgColor + "; color: " + settings.color + "; font-size: " + settings.fontSize + "px; margin-top: " + settings.marginHRI + "px;\">" + hri + "</div>";
    }
