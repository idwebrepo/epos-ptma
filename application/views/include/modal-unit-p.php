<div class="modal-body">
  <input type="hidden" id="idkatunit" name="idkatunit">
    ...
    <table id="contact-table" class="table table-sm table-striped table-hover table-responsive w-100 bg-light nowrap d-none">
      <thead>
        <tr>
          <th class="d-none"></th>
          <th></th>
          <th class="text-sm">Kode Toko</th>
          <th class="text-sm">Nama Unit/Toko</th>
        </tr>
      </thead>
    </table>
  </div>
...
<div class="modal-footer">
  ...
  <div class="form-group">
    <div class="col-sm-offset-3">
      ...
      <button type="button" id="bpilihunit" name="bpilihunit" class="btn btn-primary btn-sm px-4">Pilih</button>
    </div>
  </div>
</div>

<script src="<?= app_url('assets/dist/js/modul/include/modal-unit-p.js'); ?>"></script>