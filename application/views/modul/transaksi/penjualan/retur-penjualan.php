            ...
            <div id="col-pph22" class="col-sm-2 d-none">
              <div class="form-group">
                ...
                <label for="chkpph22" class="text-sm px-1 font-weight-normal ml-4">PPH 22 
                  <span id="persen-pph22"><?php if($pph22jual>0) echo '('.$pph22jual.'%)'; ?></span>
                </label>                                
...
<!-- JS Custom -->
<script type="module" src="<?php echo app_url('assets/dist/js/modul/transaksi/penjualan/retur-penjualan.js'); ?>"></script>
</body>
</html>