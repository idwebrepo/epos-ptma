<body id="<?= $id; ?>" class="layout-fixed bg-transparent overflow-hidden" data-panel-auto-height-mode="height">
  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <input type="hidden" id="lvlharga" name="lvlharga" value="1">      
    ...
    <section class="content" style="margin-top:70px">
      ...
      <div class="container-fluid container-absolute">
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
                <label class="text-sm px-2 font-weight-normal">Salesman *</label>
                  <div class="input-group" data-target-input="nearest">
    ...
    <section class="content mt-4">
      <div class="container-fluid">
          ...
          <div class="row px-1">
            ...
            <div class="col-sm-2 col-overlap-2">
              <div class="form-group">
                <label class="text-sm px-1 font-weight-normal">PPN <span id="persen-ppn"><?php if($ppnjual>0) echo '('.$ppnjual.'%)'; ?></span></label>
            ...
            <div id="col-pph22" class="col-sm-2 col-overlap-2 d-none">
              <div class="form-group">
                ...
                <label for="chkpph22" class="text-sm px-1 font-weight-normal ml-4">PPH 22 <span id="persen-pph22"><?php if($pph22jual>0) echo '('.$pph22jual.'%)'; ?></span></label>
...
<!-- JS Custom -->
<script type="module" src="<?php echo app_url('assets/dist/js/modul/transaksi/penjualan/faktur-penjualan-dua.js'); ?>"></script>
</body>
</html>