      ...
      <div id="dLeftFirst" class="container-fluid left px-2">
        ...
        <div class="row px-2">
          ...
          <div class="col-sm-1">
            ...
            <input id="hidden" type="text" class="form-control form-control-sm" readonly="" tabindex="-1" value="Rp">
          </div>
        </div>  
        <div class="row px-2">
...
<!-- JS Custom -->
<script type="module" src="<?php echo app_url('assets/dist/js/modul/transaksi/penjualan/uangmuka-penjualan.js'); ?>"></script>
</body>
</html>