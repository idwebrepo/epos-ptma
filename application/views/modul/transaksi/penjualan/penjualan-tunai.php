...
.header-title {
  display: none;
      ...
      #curDate, #curTime, #curUser, #curBranch, #stsBarcode {
        display: none;
      }         
      #hpos1 {
        width: 100%;
  ...
  <div class="content-wrapper tab-wrap bg-light">
    <div class="content-header bg-secondary px-4 py-2 position-fixed d-flex justify-content-between w-100" style="height:45px;">
      <div class="header-title">
        <h5 class="text-bold text-light">
        <img src="<?php echo app_url('assets/dist/img/logo-utama.png'); ?>" class="mr-2" alt="Logo" width="25" height="25">
          ePos (ePesantren) <?= @$_SESSION['namaunit']; ?></h5> 
      </div>      
      <div class="row header-action" style="z-index: 99999999">
                  ...
                  <div class="row py-0 my-0">
                    <div class="table-responsive mt-0 bg-white" tabindex="-1">
                      <table id="tdetil" class="table table-hover table-sm table-transaksi">
                        <thead class="bg-secondary" style="position: sticky; top:0;z-index: 10; opacity: 1;">
                          <tr>
