    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">      
        ...
        <div id="fDataTable" class="fDataTable d-none">
          ...
          <div class="row mt-2 mx-1 d-none">
              <div class="col-sm-12">
                ...
                <div class="input-group" data-target-input="nearest">
                  <select id="status" name="status" class="form-control form-control-sm select2">
                    ...
                    <option value="1">Dibayar Sebagian</option>
...
<!-- JS Custom -->
<script type="module" src="<?php echo app_url('assets/dist/js/modul/transaksi/pembelian/table-uangmuka-pembelian.js'); ?>"></script>
</body>
</html>