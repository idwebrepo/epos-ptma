              ...
              <div class="col-sm-12">
                ...
                <div class="input-group" data-target-input="nearest">
                  <select id="status" name="status" class="form-control form-control-sm select2">
                    ...
                    <option value="1">Diproses Sebagian</option>
...
<!-- JS Custom -->
<script type="module" src="<?php echo app_url('assets/dist/js/modul/transaksi/pembelian/table-order-pembelian.js'); ?>"></script>
</body>
</html>