<body id="<?php echo $id; ?>" class="layout-fixed overflow-hidden" data-panel-auto-height-mode="height">
  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">
        <table id="citem-table" class="table table-sm table-striped table-hover w-100 bg-light nowrap d-none">
          <thead>
            <tr>
              <th class="d-none"></th>
              <th></th>
  ...
  <!-- JS Custom -->
  <script type="module" src="<?php echo app_url('assets/dist/js/modul/master/table-kategori-item.js'); ?>"></script>
</body>
