  ...
  <div class="content-wrapper tab-wrap mx-0">
    ...
    <div class="content px-0 mx-0 ml-2" style="margin-top: 70px;">
      <div class="container-fluid mt-1 px-0 mx-0">      
        <table id="unit-table" class="table table-sm table-striped table-hover w-100 nowrap d-none">
          <thead>
          <tr>
          <th class="d-none"></th>
          <th></th>
          <th class="text-sm">Kode Toko</th>
          <th class="text-sm">Nama Toko</th>
          <!-- <th class="text-sm">Pemilik Toko</th>     -->
...
<!-- JS Custom -->
<script type="module" src="<?= app_url('assets/dist/js/modul/administrator/table-unit.js'); ?>"></script>
</body>
</html>