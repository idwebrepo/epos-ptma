<body id="<?= $id; ?>" class="layout-fixed overflow-hidden" data-panel-auto-height-mode="height">
  ...
  <div class="btn-group-vertical">
    ...
    <!-- <a id="baddUnit" class="btn btn-app">
      <i class="fas fa-plus"></i> <span>Tambah <br>Unit </span>
    </a> -->
  ...
  <!-- JS Custom -->
  <script type="module" src="<?= app_url('assets/dist/js/modul/administrator/table-user.js'); ?>"></script>
</body>
