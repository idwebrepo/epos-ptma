<?php
    ...
    $query  = "SELECT A.souid 'id',A.sounotransaksi 'nomor',DATE_FORMAT(A.soutanggal,'%d-%m-%Y') 'tanggal',B.knama 'kontak',
                      A.souuraian 'uraian', A.soukaryawan 'idkaryawan', A.soutotaltransaksi 'total', 
                      (A.soutotalpajak+A.soutotalpph22) 'totalpajak',
					  A.sousubtotal 'subtotal',B.k1alamat 'alamat',C.tnama 'termin', D.knama 'karyawan',
