...
<div class="header-report">
	...
	<div class="left">
		...
		<table class="table" style="margin-top: 5px;">
			<tbody>
				<tr>
					<td align="center" class="border-1 bg-dark" width="50%">Pajak :</td>
					<td width="10"></td>
...
<div class="content-report">
	<table class="table table-border">
		...
		<tfoot>
			...
			?>
				<td colspan="4" rowspan="3" class="left py-1 px-1" style="vertical-align: middle;">Terbilang : <?= terbilang($sisafaktur); ?></td>
			<?
				}
			?>			
