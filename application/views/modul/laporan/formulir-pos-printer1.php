...
//	include ('printer1.php');
    ...
    $query  = "SELECT A.ipuid 'id',A.ipunotransaksi 'nomor', A.IPUSUMBER 'sumber', DATE_FORMAT(A.ipucreated,'%d/%m/%Y %H:%m') 'tanggal',B.knama 'kontak',
...
<div id="wrapper">
	<div class="header-report" style="border-bottom:1px dotted #000">
		<div style="margin-bottom:5pt;">
			<h3><?= $company_name; ?><br> <?= @$_SESSION['namaunit']; ?></h3>				
	...
	<div class="footer-report" style="border-bottom: 1px dotted #000">
		<table>
			<tbody>
					...
					<tr>
						<td colspan="2" width="50%">Pem. Via <?= ($sumber=='IP' ? 'Kartu Santri' : 'Tunai')?> : Rp<?= eFormatNumber($totalbayar-$totaldiskon,0) ?></td>
