...
class PJ_Faktur_Penjualan extends CI_Controller {
   ...
   function deletedataduamulti(){
    echo $this->M_PJ_Faktur_Penjualan->hapusTransaksiDuaMulti();          
   }   
   ...
   function getdatadua(){
        ...
        $query = "SELECT  A.ipuid 'id', A.ipunotransaksi 'nomor', 
                  ...
                  B.knama 'kontak', B.kpenlevelharga 'level', A.ipuuraian 'uraian', A.ipukaryawan 'idkaryawan', 
   ...
   function getdataorder(){
      ...
      $query = "SELECT A.soditem 'item', C.inama 'namaitem', 
                       (A.sodorder-A.sodkeluar) 'qty', G.kpenlevelharga 'level',
                       A.sodharga 'harga', 
                       A.soddiskon 'diskon', 
                       ...
                       C.ihargajual1 'hargajual',C.ihargajual2 'hargajual2',
                       C.ihargajual3 'hargajual3',C.ihargajual4 'hargajual4',
                       C.isat2hargajual1 'sat2hargajual1',C.isat2hargajual2 'sat2hargajual2',
                       C.isat2hargajual3 'sat2hargajual3',C.isat2hargajual4 'sat2hargajual4',
                       C.isat3hargajual1 'sat3hargajual1',C.isat3hargajual2 'sat3hargajual2',
                       C.isat3hargajual3 'sat3hargajual3',C.isat3hargajual4 'sat3hargajual4',
                       C.isat4hargajual1 'sat4hargajual1',C.isat4hargajual2 'sat4hargajual2',
                       C.isat4hargajual3 'sat4hargajual3',C.isat4hargajual4 'sat4hargajual4',        
                       C.isat5hargajual1 'sat5hargajual1',C.isat5hargajual2 'sat5hargajual2',
                       C.isat5hargajual3 'sat5hargajual3',C.isat5hargajual4 'sat5hargajual4',
                       C.isat6hargajual1 'sat6hargajual1',C.isat6hargajual2 'sat6hargajual2',
                       C.isat6hargajual3 'sat6hargajual3',C.isat6hargajual4 'sat6hargajual4',                       
                       C.isatuan2 AS 'idsatuan2', C.isatkonversi2 'konversi2',
                       C.isatuan3 AS 'idsatuan3', C.isatkonversi3 'konversi3',
                       C.isatuan4 AS 'idsatuan4', C.isatkonversi4 'konversi4',
                       C.isatuan5 AS 'idsatuan5', C.isatkonversi5 'konversi5',
                       C.isatuan6 AS 'idsatuan6', C.isatkonversi6 'konversi6',                       
                      (SELECT isatuan FROM ainfo ORDER BY iid ASC LIMIT 1) AS 'multisatuan',
                      (SELECT gid FROM bgudang WHERE gdefault=1 LIMIT 1) 'idgudang',
                      (SELECT gnama FROM bgudang WHERE gdefault=1 LIMIT 1) 'gudang'               
                  FROM esalesorderd A
            INNER JOIN esalesorderu B ON B.souid=A.sodidsou
             ...
             LEFT JOIN bkontak G ON B.soukontak=G.kid 
