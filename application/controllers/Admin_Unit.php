...
class Admin_Unit extends CI_Controller
{
    ...
    function savedata()
    {
        if ($this->input->post('id') == '') {
            echo $this->M_Admin_Unit->tambahData();
        } else {
            echo $this->M_Admin_Unit->ubahData();
        }
    }

    function savepassword()
    {
        echo $this->M_Admin_Unit->simpanPassword();
    }

    function deletedata()
    {
        echo $this->M_Admin_Unit->hapusData();
    }
    ...
    function getinfounit()
    {
        $query = "SELECT * 
                    FROM aunit WHERE utid = " . $this->input->post('id');
